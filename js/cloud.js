...
function animateOnScroll() {
    const elements = document.querySelectorAll('.hero-content, .hero-image, .about-image, .about-text, .service-card, .portfolio-item, .blog-card, .contact-info, .contact-form, .stat-card, .team-card, .feature-item, .security-card');
...
// ==================== CLOUD SECURITY CARDS FADE-UP ANIMATION ====================
function animateCloudSecurityCards() {
    const cloudSecuritySection = document.querySelector('.cloud-security');
    const securityCards = document.querySelectorAll('.security-card');
    const windowHeight = window.innerHeight;

    // Check if the cloud security section is in view
    const sectionPosition = cloudSecuritySection.getBoundingClientRect();

    if (sectionPosition.top < windowHeight && sectionPosition.bottom > 0) {
        cloudSecuritySection.classList.add('fade-up-animated');
...
// Additional animation for security icons on hover
...
document.head.insertAdjacentHTML('beforeend', `
            <style>
                ...
                .security-card.fade-up-animated {
                    opacity: 1;
                ...
                .cloud-security.fade-up-animated {
                    opacity: 1;
                    transform: translateY(0);
                }
            </style>
