...
function animateOnScroll() {
    const elements = document.querySelectorAll('.webdev-card, .section-title, .section-subtitle, .tagline');
...
// ==================== CARD INTERACTIONS ====================
const cards = document.querySelectorAll('.webdev-card');

cards.forEach(card => {
    // Add hover effect to webdev cards
...
// ==================== WEB DEVELOPMENT PAGE SPECIFIC FUNCTIONALITY ====================

// Technology tooltips
const techItems = document.querySelectorAll('.backend-technologies li');
...
const backToHome = document.querySelector('.back-to-home a');
if (backToHome) {
